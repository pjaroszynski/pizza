...
/* ********************************************************************
   ...
   ******************************************************************** */
int multihuf_decompr(uchar *dest, int alpha_size, int limit)
{
...
/* ************************************************************
   ...
   ************************************************************ */
void uncompress_bucket_multihuf(uchar *dest, int len, int alpha_size)
{
  int int_log2(int);
  ...
  assert(Mtf_save==256);
  /* ---------- init ------------ */
  init_bit_buffer();         // this should not be necessary
  ...
  aux_len = multihuf_decompr(dest,local_alpha_size,len);
  if(aux_len!=len)
